  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg border-white/70 bg-white/90 p-6 backdrop-blur-2xl dark:border-white/10 dark:bg-[#172231]/95">
        <DialogHeader><DialogTitle className="flex items-center gap-2"><Bell className="h-5 w-5 text-[#9a7d49]" />公告</DialogTitle><DialogDescription>沐莫AI 的近期动态</DialogDescription></DialogHeader>
